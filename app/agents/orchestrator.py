    ...
    def create_initial_plan(
        ...
        research_task = AgentTask(
            ...
            description=(
                ...
                "technologies, tradeoffs, and risks."
            ),
            assigned_agent=(
                AgentRole.RESEARCH
            ),
        ...
        architecture_task = AgentTask(
            ...
            description=(
                "Design the system using validated "
                "requirements and evidence-backed research."
            ),
            assigned_agent=(
                AgentRole.ARCHITECT
            ),
        ...
        implementation_task = AgentTask(
            ...
            description=(
                "Write the required application code."
            ),
            assigned_agent=(
                AgentRole.CODER
            ),
        ...
        critic_task = AgentTask(
            ...
            description=(
                ...
                "security, and requirement coverage."
            ),
            assigned_agent=(
                AgentRole.CRITIC
            ),
